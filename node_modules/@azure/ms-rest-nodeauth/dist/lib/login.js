...
function withAuthFileWithAuthResponse(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (envFound.name) {
            optionsForSpSecret.environment = ms_rest_azure_env_1.Environment[envFound.name];
        }
        else {
            ...
            optionsForSpSecret.environment = ms_rest_azure_env_1.Environment.add(envParams);
        }
