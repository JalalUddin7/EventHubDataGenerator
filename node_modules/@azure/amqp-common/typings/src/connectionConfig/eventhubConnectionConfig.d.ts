...
export declare module EventHubConnectionConfig {
     ...
     */
    function create(connectionString: string, path?: string): EventHubConnectionConfig;
    /**
     ...
     */
    function createFromConnectionConfig(config: ConnectionConfig): EventHubConnectionConfig;
    /**
     * Validates the properties of connection config.
     * @param {ConnectionConfig} config The connection config to be validated.
     * @returns {void} void
     */
    function validate(config: EventHubConnectionConfig): void;
}
